          ...
          <>
            ...
            <Routes>
              ...
              <Route
                exact
                path="/MyPackage"
                element={<MyPackage user={user} />}
              />
              <Route
                exact
                path="/UploadPackage"
                element={<UploadPackage user={user} />}
              />
              <Route
                exact
                path="/PackageApproval"
                element={<PackageApproval user={user} />}
              />
              <Route
                exact
                path="/SystemRequest"
                element={<SystemRequest user={user} />}
              />
            </Routes>
          </>
        ) : (
